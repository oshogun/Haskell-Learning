...
/* package Haskell-Sudoku-0.0.0.1 */
#ifndef VERSION_Haskell_Sudoku
#define VERSION_Haskell_Sudoku "0.0.0.1"
#endif /* VERSION_Haskell_Sudoku */
#ifndef MIN_VERSION_Haskell_Sudoku
#define MIN_VERSION_Haskell_Sudoku(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_Sudoku */
...
#define CURRENT_COMPONENT_ID "Haskell-Sudoku-0.0.0.1-inplace-Haskell-Sudoku"
